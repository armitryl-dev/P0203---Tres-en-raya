class Board {
    private board: string[]; // Almacena el estado del tablero
    private currentPlayer: string; // Almacena el jugador actual
    private isGameOver: boolean; // Indica si el juego ha terminado
    private boardElement: HTMLElement; // Elemento HTML que representa el tablero
    private statusElement: HTMLElement; // Elemento HTML que muestra el estado del juego
    private currentPlayerLogo: HTMLElement; // Elemento HTML que muestra el logo del jugador actual

    constructor(boardElement: HTMLElement, statusElement: HTMLElement, currentPlayerLogo: HTMLElement) {
    ...
    private handleCellClick(event: Event) {
        const target = event.target as HTMLElement; // Obtiene el elemento objetivo del evento
    ...
    private checkWinner(): boolean {
        ...
        return winningCombinations.some(combo => {
            ...
            return (
                this.board[a] && // Verifica que el primer elemento no esté vacío
